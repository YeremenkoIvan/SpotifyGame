...
import recomendations from "../../data/recomendations.json" assert { type: "json" };
...
export const getRecommendationFromFile = async (randomID) => {
  const recommendation = recomendations[randomID];
